...
var Context_Situations = [
    ...
    [
        [
            ...
            "- 나도 듣고 싶어.",
            "?",
            "?[농담내용] 그냥 말장난인데, 재미 하나도 없었어.",
            "[농담내용]",
            "- 난 교수님이 수업 시간에 농담하는 것이 좋아.",
            "- 잘 생기셨잖아. 안 그래?",
            "?",
            "?[정말] 교수님이 잘 생기시긴 했지.",
            "?[아니] 무슨 소리야? 끔찍한 소리 하지 마.",
            "[정말]",
            "- 농담인데... 네가 그렇게 생각할 줄은 몰랐어.",
            "- 취향 존중한다.",
            "__FIN__",
            "[아니]",
            "- 역시 그렇지?",
        ...
        [
            ...
            "- 언제부터 그랬어?",
            "?",
            "?[어제] 어제 숙제한다고 밤을 새서 이런 것 같아.",
            "?[일주일] 저번 주에 축제 때문에 무리를 했어.",
            "[어제]",
            "- 가끔은 숙제를 미뤄도 괜찮아.",
            "- 건강이 먼저라고 생각해.",
            "__FIN__",
